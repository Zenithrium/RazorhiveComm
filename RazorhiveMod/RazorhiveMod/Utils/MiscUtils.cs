...
namespace RazorwireMod.Utils
{
    public static class MiscUtils
    {
        ...
        public static Vector3 FindClosestNodeToPosition(Vector3 position, HullClassification hullClassification, bool checkAirNodes = false)
        {
            ...
            RazorwireModPlugin.ModLogger.LogInfo($"No closest node to be found for XYZ: {position}, returning 0,0,0");
            return Vector3.zero;
        }
...
//#pragma warning restore Publicizer001 // Accessing a member that was not originally public
        ...
        public static Dictionary<string, Vector3> GetAimSurfaceAlignmentInfo(Ray ray, int layerMask, float distance)
        {
            ...
            if (!didHit)
            {
                RazorwireModPlugin.ModLogger.LogInfo($"GetAimSurfaceAlignmentInfo did not hit anything in the aim direction on the specified layer ({layerMask}).");
                return null;
            }
